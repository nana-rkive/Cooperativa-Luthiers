      ...
      @if (loading()) {
        ...
        @if (isEmpty()) {
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p class="mt-2 text-sm text-gray-500">Adicione um novo instrumento para iniciar o acompanhamento.</p>
            <div class="mt-6">
              <a routerLink="/instrumentos/novo" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
