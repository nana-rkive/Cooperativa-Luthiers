    ...
    <div class="min-h-screen bg-gray-100">
      ...
      <main class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-6 items-stretch" [class.md:grid-cols-3]="authService.isAdmin()" [class.md:grid-cols-2]="!authService.isAdmin()">
          ...
          <a routerLink="/instrumentos" class="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow cursor-pointer border border-gray-100 flex flex-col h-full min-h-[8rem]">
            <div class="p-6 flex-1 flex items-center gap-4">
              <div class="flex-shrink-0 bg-green-100 rounded-md p-3">
                <!-- Ícone de Guitarra / Violão Clássico -->
                <svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet" class="w-8 h-8 text-green-600">
